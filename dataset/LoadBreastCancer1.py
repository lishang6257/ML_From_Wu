...
class LoadBreastCancer1(object):
    def __init__(self):
        ...
        self.__data = r'..\MLDataset\breast-cancer-wisconsin\1\breast-cancer-wisconsin.data'
        self.__attribute = r'..\MLDataset\breast-cancer-wisconsin\1\breast-cancer-wisconsin.attribute'
